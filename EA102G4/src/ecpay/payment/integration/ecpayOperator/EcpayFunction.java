...
//		System.out.println(plaintext.length());
	...
	/**
	 * Â∞áÁâ©‰ª∂Á?ÑÂ±¨?ßË?áÊ™¢?ü•Á¢ºÁ?ÑÂ?àÊ?êhttp??ÑÂ?ÉÊï∏Ë≥áÊ?ôÊ†ºÂº?
	 * @param obj
	 * @param CheckMacValue
	 * @return string
	 */
	...
	/**
	 * ??ùÂ?çÁâ©‰ª∂ÂÖßÂ±¨Ê?ßÁ?ÑÂ?ÉÊï∏‰ΩúÊ?íÂ??
	 * @param Class
	 * @return List
	 */
	...
	/**
	 * Â∞áÂ?öÂ?åÁ?ÑurlEncodeÂ≠ó‰∏≤??öË?âÊ?õÁ¨¶??? .NETË™ûË???ÑË?âÊ?õË?èÂ??
	 * @param url
	...
	/**
	 * Â∞? byte array Ë≥áÊ?ôÂ?? hash md5??? sha256 ??ãÁ?óÔ?å‰∏¶??ûÂÇ≥ hex?ºÁ?ÑÂ?ó‰∏≤Ë≥áÊ??
	 * @param data
	 * @param isMD5
	 * @return string
	 */
	...
	/**
	 * Â∞? byte array Ë≥áÊ?ôË?âÊ?õÊ?? hexÂ≠ó‰∏≤??
	 * @param bytes
	 * @return string
	 */
