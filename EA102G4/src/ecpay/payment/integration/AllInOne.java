...
public class AllInOne extends AllInOneBase{
	 ...
	 * ??ÉÊï∏Â∏∂ÂÖ•log4j.properties??ÑË∑ØÂæëÔ?åËã•Â∏∂ÂÖ•Á©∫Â?ó‰∏≤??áÈ?êË®≠‰∏çÁî¢??ülog
	...
	/**
	 * Ê™¢Êü•Hashtable‰∏≠Á?ÑÊ™¢?ü•Á¢ºÊòØ?ê¶Ê≠?Á¢?(Á¢∫‰?ùË?áÊ?ôÊú™Ë¢´Á?ÑÊîπ)
	...
	/**
	 * ‰∏ãË?â‰ø°?î®?ç°?í•Ê¨æÂ?çÂ∏≥Ë≥áÊ?ôÊ?îÁ?ÑÊñπÊ≥?
	...
	/**
	 * ?ü•Ë©¢‰ø°?î®?ç°?ñÆÁ≠ÜÊ?éÁ¥∞Ë®òÈ?ÑÁ?ÑÊñπÊ≥?
	 * @param queryTradeObj
	 * @return response string
	 */
	...
	/**
	 * ‰∏ãË?âÊ?ÉÂì°Â∞çÂ∏≥Â™íÈ?îÊ?îÁ?ÑÊñπÊ≥?
	 * @param tradeNoAioObj
	 * @return response string
	 */
	...
	/**
	 * ATM?ÅCVS??ñBARCODE??ÑÂ?ñË?üÁ?êÊ?úÈ?öÁü•?ñπÊ≥ï„?ÇÊé•?î∂?Ç≥?ÅËá≥PaymentInfoURL??ÑË?áÊ?ô„?ÇÂ?ûÂÇ≥?â©‰ª∂Â?ÜÁÇ∫ATMRequestObj, CVSOrBARCODERequestObj‰∫åÁ®ÆÔºåË?ãÁî®?Å©?ï∂??ÑÁâ©‰ª∂Êâø?é•‰ª•Â?çÂá∫?åØ
	 * @param req
	 * @return obj
	 */
