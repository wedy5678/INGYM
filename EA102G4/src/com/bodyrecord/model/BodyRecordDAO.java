...
public class BodyRecordDAO implements BodyRecordDAO_interface {
	...
	private static final String GET_ALL_STMT = 
			"SELECT BODY_NO, MEM_ID, MEM_HEIGHT, MEM_WEIGHT, MEM_BMI, MEM_OLD, MEM_BMR, FREQUENCY, MEM_TDEE,to_char(BODY_DATE,'yyyy-mm-dd')BODY_DATE,PHOTO FROM BODY_RECORD order by BODY_DATE DESC,BODY_NO DESC";
