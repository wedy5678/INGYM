...
import com.product_comment.model.ProductCommentService;
...
public class ProductCommentServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("insertProductComment".equals(action)) {
...
//			req.setAttribute("errorMsgs", errorMsgs);
			...
			try {
				/*************************** 1.接收請求參數 ****************************************/
				String memIdBuyer = req.getParameter("memIdBuyer");
				String memIdSeller = req.getParameter("memIdSeller");
				String productNo = req.getParameter("productNo");
				String productComment = req.getParameter("productComment");
				String pRatingEach = req.getParameter("pRatingEach");
				System.out.println("pRatingEach: " + pRatingEach);
				System.out.println("memIdBuyer : " + memIdBuyer);
				System.out.println("memIdSeller : " + memIdSeller);
				System.out.println("productNo : " + productNo);

				/*************************** 2.開始查詢資料 ****************************************/
				ProductCommentService productCommentService = new ProductCommentService();
				productCommentService.addProductComment(memIdBuyer, memIdSeller, productNo, productComment,pRatingEach);
