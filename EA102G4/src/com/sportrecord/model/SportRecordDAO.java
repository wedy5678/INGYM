...
public class SportRecordDAO implements SportRecordDAO_interface {
	...
	public SportRecordVO insert(SportRecordVO sportRecordVO) {
		...
		try {
			...
			SportRecordVO lastOne = sportRecordSvc.getOneSportRecordByMemIdLast(sportRecordVO.getMem_id());
			
			
			sportRecordVO.setRecord_no(lastOne.getRecord_no());
