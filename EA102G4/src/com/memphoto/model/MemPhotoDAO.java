...
public class MemPhotoDAO implements MemPhotoDAO_interface {
	...
	private static final String GET_ONE_STMT = 
			"SELECT PHOTO_NO, MEM_ID, PHOTO_STATUS, PHOTO FROM MEMBER_PHOTO where MEM_ID = ? and PHOTO_STATUS = 'P0' ORDER BY PHOTO_NO DESC";
