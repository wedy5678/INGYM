...
<body>
			...
			<div class="container nav-container">
				...
				<div class="collapse navbar-collapse" id="billatrail_main_menu">
					<ul class="navbar-nav menu-open">
						...
						<li class="menu-item-has-children"><a href="#">Member</a>
							<ul class="sub-menu">
								<li><a
									href="<%=request.getContextPath()%>/front-end/mem/memDetail.jsp">MemberDetail</a></li>
								<li><a
									href="<%=request.getContextPath()%>/front-end/bodyrecord/bodyRecord.jsp">BodyRecord</a></li>
								<li><a
									href="<%=request.getContextPath()%>/front-end/sportrecord/sportRecord.jsp">SportRecord</a></li>
								<li><a href="#">FoodRecord</a></li>
								<%
									if (memVOLogin != null) {
								%>
								<li><a
									href="<%=request.getContextPath()%>/front-end/mem/changeMyPassword.jsp">ChangeMyPassword</a></li>
								<%
									}
								%>
							</ul></li>
	...
	<div class="breadcrumb-style-1"
		...
		<div class="breadcrumb-inner">
			<h1 class="page-title">Update MySportData</h1>
		</div>
	</div>
	<!-- breadcrumb area end -->
							...
							<div class="container">
								<div class="row">
									...
									<form METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/sportrecord/sportrecord.do" name="form1">
										<div class="form-row">
											...
											<input type="hidden" name="record_no" size="30"
													value="<%=sportRecordVO.getRecord_no()%>" />
											...
											<div class="form-group text-left" id="unit1">
												<input type="text" class="form-control" id="record1" name="record1" value="<%=(sportRecordVO == null) ? "" : sportRecordVO.getRecord1()%>" placeholder="公斤" required>
											</div>
											<div class="form-group text-left" id="unit2">
												<input type="text" class="form-control" id="record2" name="record2" value="<%=(sportRecordVO == null) ? "" : sportRecordVO.getRecord2()%>" placeholder="次" required>
											</div>
									...
									<div class="form-group">
										...
										<input type="hidden" name="record_no" value="<%=sportRecordVO.getRecord_no()%>"> 
			...
			.addEventListener(
					...
					function() {
						if (sport_no.value == "SPORT00001") {
							unit1.innerHTML = '<input type="text" class="form-control" name="record1" value="" placeholder="公斤"/>';
							unit2.innerHTML = '<input type="text" class="form-control" name="record2" value="" placeholder="次"/>';

						} else if (sport_no.value == "SPORT00002"
								|| sport_no.value == "SPORT00003") {
							unit1.innerHTML = '<input type="text" class="form-control" name="record1" value="" placeholder="公尺"/>';
							unit2.innerHTML = '<input type="text" class="form-control" name="record2" value="" placeholder="分鐘"/>';
						} else {
							unit1.innerHTML = '<input type="text" class="form-control" name="record1" value="" placeholder="分鐘"/>';
							unit2.innerHTML = '<input type="hidden" class="form-control" name="record2" value="0"/>';
						}
					});

	window.onload = function() {
		if (sport_no.value == "SPORT00001") {
			unit1.innerHTML = '<input type="text" class="form-control" name="record1" value="<%=sportRecordVO.getRecord1()%>" placeholder="公斤"/>';
			unit2.innerHTML = '<input type="text" class="form-control" name="record2" value="<%=sportRecordVO.getRecord2()%>" placeholder="次"/>';
		} else if (sport_no.value == "SPORT00002"
				|| sport_no.value == "SPORT00003") {
			unit1.innerHTML = '<input type="text" class="form-control" name="record1" value="<%=sportRecordVO.getRecord1()%>" placeholder="公尺"/>';
			unit2.innerHTML = '<input type="text" class="form-control" name="record2" value="<%=sportRecordVO.getRecord2()%>" placeholder="分鐘"/>';

		} else {
			unit1.innerHTML = '<input type="text" class="form-control" name="record1" value="<%=sportRecordVO.getRecord1()%>" placeholder="分鐘"/>';
			unit2.innerHTML = '<input type="hidden" class="form-control" name="record2" value="0"/>';
		}
	};
</script>
