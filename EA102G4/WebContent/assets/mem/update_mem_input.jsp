...
<!-- 				<td>密碼:</td> -->
			...
			<tr>
				...
				<td>
					...
					name="sex" value="男" checked> <label for="male">男</label> <input
					type="radio" id="female" name="sex" value="女"> <label
					for="female">女</label><br> 
					<%} else {%>
					<input type="radio"
					id="male" name="sex" value="男"><label for="male">男</label>
					<input type="radio" id="female" name="sex" value="女" checked><label
					for="female">女</label><br>
					<%}%>
				</td>
			</tr>
...
<!-- 				<td>點數:</td> -->
			...
			<tr>
				<td>自我介紹:</td>
				<td><input type="TEXTAREA" name="mem_resume" size="45"
