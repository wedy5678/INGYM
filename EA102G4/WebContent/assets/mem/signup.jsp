				...
				<div class="col-xl-6 col-lg-6 right-div">
					<div class="sign-content text-center h-100">
						...
						<form METHOD="post" ACTION="<%=request.getContextPath() %>/front-end/mem/mem.do" name="form1">
							...
							<input type="submit" class="btn btn-success btn-lg btn-block" value="Join our community">
							<button id = "magical-button">Magical Button</button>
						</form>
					</div>
				</div>
			</div>
...
<script>
	...
	$('#magical-button').click(function(e){
		e.preventDefault();
		$('#mem_name').val("大衛海鮮");
		$('#mem_email').val("mmmm50306@gmail.com");
		$('#mem_bir').val("1987-08-07");
		$('#mem_addr').val("中豐路南勢二段457巷12號");
