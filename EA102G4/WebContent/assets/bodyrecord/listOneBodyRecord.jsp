...
List<BodyRecordVO> list = bodyRecordSvc.getOneBodyRecordByMemId("MEM0000001"); //session.getAttribute("memVO").mem_id
pageContext.setAttribute("list", list);
%>

<html>
<head>
<title>會員個人身體數據資料 - listOneBodyRecord.jsp</title>
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>會員個人身體數據資料 - listOneBodyRecord.jsp</h3>
				<h4>
	...
	<table>
		...
		<c:forEach var="bodyRecordVO" items="${list}" begin="<%=pageIndex%>"
			...
			<tr>
				...
				<td>
					<FORM METHOD="post"
						ACTION="<%=request.getContextPath()%>/front-end/bodyrecord/bodyrecord.do"
						style="margin-bottom: 0px;">
						<input type="submit" value="修改資料"> <input type="hidden"
							name="body_no" value="${bodyRecordVO.body_no}"> <input
