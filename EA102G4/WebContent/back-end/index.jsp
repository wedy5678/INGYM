			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="seven" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<%=request.getContextPath() %>/back-end/food/listAllFoodBackEnd.jsp">搜尋食物資料庫</a> <a
							class="collapse-item" href="<%=request.getContextPath() %>/back-end/food/addFood.jsp">新增食物資料</a>
					</div>
				</div></li>
