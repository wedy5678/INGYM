    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="row justify-content-center">
			...
			<table style="border:3px #cccccc solid;" cellpadding="10" border='0' id="abc">
				<tr>
				...
				<tr>
					<td>員工姓名:</td>
					<td><input type="TEXT" name="w_name" size="30" value="<%=workerVO.getW_name()%>" /></td>
				</tr>
				<tr>
					<td>帳號:</td>
					<td><input type="TEXT" name="w_acc" size="30" value="<%=workerVO.getW_acc()%>" /></td>
				</tr>
				<tr>
					<td>密碼:</td>
					<td><input type="TEXT" name="w_pw" size="30" value="<%=workerVO.getW_pw()%>" /></td>
				</tr>
				<tr>
					<td>信箱:</td>
					<td><input type="TEXT" name="email" size="30" value="<%=workerVO.getEmail()%>" /></td>
				</tr>
				<tr>
					<td>雇用日期:</td>
				...
				<tr>
       			...
       			<tr>
      				<td colspan="2"><img src="<%=request.getContextPath() %>/workerptool.do?work_id=<%=workerVO.getWork_id()%>" id="image" height=200px style="display:block; margin:auto;" ></td>      				
      			</tr>
				<tr>
      				<td colspan="2">權限:
