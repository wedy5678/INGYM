	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-controls="four"> <i class="fas fa-store"></i> <span>商城</span>
			</a>
				<div id="four" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Mall Components:</h6>
						<a class="collapse-item" href="<%=request.getContextPath()%>/back-end/product/listAllProduct.jsp">商品管理</a> <a
							class="collapse-item" href="<%=request.getContextPath()%>/back-end/product/listAllOrder.jsp">訂單管理</a>
					</div>
				</div></li>
			...
			<li class="nav-item active"><a class="nav-link collapsed" href="#"
				...
				<div id="seven" class="collapse show " aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item active"
							href="<%=request.getContextPath()%>/back-end/food/addFood.jsp">新增食物資料</a>
					</div>
				</div></li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">新增食物資料</h1>
				...
				<div class="row justify-content-center">
					...
					<FORM METHOD="post" ACTION="<%=request.getContextPath() %>/back-end/food/food.do" name="form1">
						<%-- 錯誤表列 --%>
						...
						<table class="table text-nowrap" style="border:3px #cccccc solid;">
							<tr>
								<td colspan=2><img src="images/food.jpg" width=100%
									height="150" border="0"></td>
							</tr>					
							<tr>
								<td>食物名稱:</td>
								<td><input type="TEXT" name="food_name" id="food_name" size="40"
									value="<%=(foodVO == null) ? "" : foodVO.getFood_name()%>" /></td>
							</tr>
							<tr>
								<td>澱粉(g):</td>
								<td><input type="TEXT" name="starch" id="starch" size="40"
									value="<%=(foodVO == null) ? "" : foodVO.getStarch()%>" /></td>
							</tr>
							<tr>
								<td>蛋白質(g):</td>
								<td><input type="TEXT" name="protein" id="protein" size="40"
									value="<%=(foodVO == null) ? "" : foodVO.getProtein()%>" /></td>
							</tr>
							<tr>
								<td>脂肪(g):</td>
								<td><input type="TEXT" name="fat" id="fat" size="40"
									value="<%=(foodVO == null) ? "" : foodVO.getFat()%>" /></td>
							</tr>
							<tr>
								<td>熱量(kcal):</td>
								<td><input type="TEXT" name="kcal" id="kcal" size="40"
									value="<%=(foodVO == null) ? "" : foodVO.getKcal()%>" /></td>
							</tr>							
						</table>
