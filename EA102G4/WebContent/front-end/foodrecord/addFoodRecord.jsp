                        ...
                        <form METHOD="post" ACTION="<%=request.getContextPath() %>/front-end/foodrecord/foodrecord.do" name="form1" enctype="multipart/form-data">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 text-left">
                                    ...
                                    <input type="text" class="form-control" id="food_name" name="food_name" size="20" value="${(foodrecordVO==null)? '': FoodSvc.getOneFood(foodrecordVO.food_no).food_name}" required>
                                </div>                                                                        
                                <div class="form-group col-md-6 text-left">
...
<% 
  ...
  try {
	  foodr_date = foodrecordVO.getFoodr_date();
   } catch (Exception e) {
...
<script>
        ...
        $('#f_date1').datetimepicker({
		   ...
		   value: '<%=foodr_date%>', // value:   new Date(),
