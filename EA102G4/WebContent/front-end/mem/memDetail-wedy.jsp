		...
		<nav class="navbar navbar-area navbar-expand-lg black-bg nav-style-02">
			<div class="container nav-container">
				...
				<div class="collapse navbar-collapse" id="billatrail_main_menu">
					<ul class="navbar-nav menu-open">
						...
						<li class="menu-item-has-children  current-menu-item">
							...
							<ul class="sub-menu">
								<li>
									<a href="<%=request.getContextPath()%>/front-end/mem/memDetail.jsp">MemberDetail</a>
								</li>
								<li>
									<a href="<%=request.getContextPath()%>/front-end/bodyrecord/bodyRecord.jsp">BodyRecord</a>
								</li>
								<li>
									<a href="<%=request.getContextPath()%>/front-end/sportrecord/sportRecord.jsp">SportRecord</a>
								</li>
								<li>
									<a href="#">FoodRecord</a>
								</li>
								...
								%>
								<li>
									<a href="<%=request.getContextPath()%>/front-end/mem/changeMyPassword.jsp">ChangeMyPassword</a>
								</li>
								<%
									}
								%>
				...
				<%
					if (memVOLogin != null) {
				%>
				<a id="hi_mem" class="current-menu-item" href="<%=request.getContextPath()%>/front-end/mem/memDetail.jsp">
					Welcome!<%=memVOLogin.getMem_name()%></a>
				<%
					}
				%>
					...
					<div class="row border-custom">
						...
						<div class="col-md-7 d-flex align-items-center">
							<div class="content ">
								...
								<p class="pb-3">
									註冊日期 :
									<fmt:formatDate value="<%=memVO.getM_reg_date()%>" pattern="yyyy-MM-dd" />
								</p>
								<ul class="social">
									<li class="icon-list">
				...
				<div class="biography-area">
					<div class="biography-content">
						<ul class="nav nav-pills">
							<li>
								<a data-toggle="pill" href="#allmemphoto" class="active"><%=memVO.getMem_name()%>'s PhotoBox
								</a>
							</li>
							<li>
												...
												<li class="comment">
													<div class="single-comment justify-content-between d-flex">
														<div class="user justify-content-between d-flex">
															<div class="thumb">
																<img src="<%=request.getContextPath() %>/front-end/memphoto/allmemphoto.do?photo_no=${memPhotoSvc.getOneMemPhoto(productCommentVO.memIdSeller).size() != 0 ? memPhotoSvc.getOneMemPhoto(productCommentVO.memIdSeller).get(0).photo_no : ""}" alt="" style="width: 100px; height: 100px"> 
