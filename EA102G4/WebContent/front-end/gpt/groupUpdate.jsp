...
<%
	...
	GroupVO groupVO = groupSvc.getOneGroup(request.getParameter("gro_no"));
			...
			<div class="row">
					...
					<FORM METHOD="post" action="group.do" method="post" enctype="multipart/form-data">
						<div class="content-part">
							...
							<div class="row">
								...
								<div class="col-lg-12">
									<h2 style="font-family:microsoft JhengHei;">修改揪團資料:</h2>
								</div>
									...
									<div class="form-group">
										<label for="sel1"><span class="material-icons">sports_handball</span>揪團種類:</label> <select class="form-control" id="show" name="type_no">
											<c:forEach var="grouptypeVO" items="${grouptypeSvc.all}">
												<option value="${grouptypeVO.type_no}" ${(grouptypeVO.type_no==groupVO.type_no)?'selected':''}>${grouptypeVO.type_name}
											</c:forEach>
										</select>
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="form-group">
										<label for="gro_min"><span class="material-icons">person</span>最小人數:</label> <input type="text" class="form-control" name="gro_min" placeholder="請輸入最小人數"
								...
								<div class="col-lg-6">
									<div class="form-group">
										<label for="gro_max"><span class="material-icons">people</span>最大人數:</label> <input type="text" class="form-control" name="gro_max" placeholder="請輸入最大人數"
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<textarea id="cate" class="form-control" rows="7" name="gro_intro"><%=groupVO.getGro_intro()%></textarea>
									</div>
								</div>
								...
								<div class="btn-wrapper" style="text-align: center;margin-bottom: 55px;width: 100%;">
									<input type="submit" class="btn btn-element btn-medium-size btn-main-color btn-rounded" value="Confirm" style=" width: 49%;"> 
									<input type="button" class="btn btn-element btn-medium-size btn-main-color btn-rounded" value="Back" onclick="history.back()" style=" width: 49%;">
								</div>

								<input type="hidden" name="action" value="update"> 
								<input type="hidden" name="gro_no" value="<%=groupVO.getGro_no()%>">
								<input type="hidden" name="gro_status" value="<%=groupVO.getGro_status()%>">
								<input type="hidden" name="gro_lat" value="${groupVO.gro_lat }" id="gro_lat">
								<input type="hidden" name="gro_lng" value="${groupVO.gro_lng }" id="gro_lng">
								<!---------------------------------填寫購物資料------------------------------------>
							</div>
						</div>
					</FORM>
				...
				<div class="col-lg-5">
					...
					<div class="col google-map">
						...
						<div id="map"></div>
						<div id="preview">
							<img src="pictool.do?gro_no=<%=groupVO.getGro_no()%>" id="gro_pic_preview" width=400px height=274px>
						</div>
					</div>
...
<%@ include file="include/chatBox.file"%>
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBw1IB_wF8J22LKiqPxdO8wbfWgFIpoDTo&libraries=places&callback=initMap" defer></script>
</body>
</html>