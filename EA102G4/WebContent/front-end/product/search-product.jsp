...
// 	List<ProductVO> list2 = (List<ProductVO>) request.getAttribute("collect");
...
list = (List<ProductVO>) request.getAttribute("collect");
...
%>
<jsp:useBean id="categoryService" scope="page"
		...
		<div class="container">
			...
			<div class="row shopping-slider-item text-center">
				...
				<c:forEach var="productVO" items="${list}" begin="<%=pageIndex%>"
					...
					<div class="col-md-3">
						<div class="shop-single-item margin-bottom-50">
							<div class="top-content" style="text-align: -webkit-center;">
								<div class="thumb" style="width: 198px; height: 198px; display: flex; align-items: center; justify-content: center;">
									<img
										src="data:image/jpg;base64,${photoService.getFirstPhoto(productVO.getProductNo()).base64Image}"
										style="max-width: 198px; max-height: 198px" />
								</div>
								<div class="hover-content">

									<div class="btn-wrapper desktop-center">
										<FORM METHOD="post"
											action="${pageContext.request.contextPath}/purchase_order/purchaseOrder.do"
											id="go">
											<a href="#"
												class="btn btn-element btn-normal-size btn-rounded"
												onclick=buyIt(this)>直接購買</a> <input type="hidden"
												name="action" value="getOneForOrder"> <input
												type="hidden" name="productNo"
												value="${productVO.productNo}"> <input type="hidden"
												name="quantity" value="${productVO.productNo}">
										</FORM>
									</div>
							...
							<div class="bottom-content">
								...
								<FORM METHOD="post"
									...
									<h5>
										<a href="#" onclick=sub(this)>${productVO.pName}<input
											type="hidden" name="productNo" value="${productVO.productNo}">
									...
									<ins>
										<span class="woocommerce-Price-amount amount"> <span
											class="woocommerce-Price-currencySymbol"><fmt:formatNumber
													value="${productVO.pPrice}" pattern="0.#" /></span>元 <!-- 商品價格 -->
										</span>
									</ins>
								</p>
							</div>
				...
				<div class="col-md-12"><%@ include
						file="../product/pages/page2.file"%></div>
			</div>
		</div>
	</section>
	<!-- home shopping end -->
