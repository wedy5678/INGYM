...
<!-- 	</tr> -->
	...
	<tr>
		<td>休息時間:</td>
		<td>		
			<input type="checkbox" name="dawn" id="dawn" value="111111000000000000000000"/><label for="dawn">0~6</label>
			<input type="checkbox" name="morning" id="morning" value="000000111111000000000000"/><label for="morning">6~12</label>
			<input type="checkbox" name="evening" id="evening" value="000000000000111111000000"/><label for="evening">12~18</label>
			<input type="checkbox" name="night" id="night" value="000000000000000000111111"/><label for="night">18~0</label>
		</td>
	</tr>
...
<% 
  ...
  try {
	  close_date = dayoffVO.getClose_date();
   } catch (Exception e) {
...
<script>
        ...
        $('#f_date1').datetimepicker({
		   ...
		   value: '<%=close_date%>', // value:   new Date(),
