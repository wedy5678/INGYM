...
<title>檢舉資料修改 - update_Article_Rep.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>檢舉資料修改 - update_Article_Rep.jsp</h3>
...
<table>
	...
	<td>	
		<select size="1" name="art_rep_no">
					<option value="R0" ${(article_repVO.getCom_status=="R0")? 'selected':'' }>檢舉未處理
					<option value="R1" ${(article_repVO.getCom_status=="R1")? 'selected':'' }>檢舉通過
					<option value="R2" ${(article_repVO.getCom_status=="R2")? 'selected':'' }>檢舉未通過
			       	</select>	
		</td>
	</tr>
