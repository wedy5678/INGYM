...
<script src="${pageContext.request.contextPath}/front-end/purchase-order/assets/js/wedy-add-order.js"></script>
				...
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<div class="content-part">
							...
							<!---------------------------------填寫購物資料------------------------------------>
							<h3 style="font-family: Microsoft JhengHei; font-size: 30px; font-weight: 500;">填寫購買詳情</h3>
							...
							<div class="form-group">
								...
								<input type="text" id="buyerName" name="buyerName" value="${purchaseOrderVO.buyerName }" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" id="buyerName">
							</div>
							<div class="form-group">
							...
							<!-- 填寫信用卡訊息-start -->
							<!-- 							<span class="specifications mt-2"> -->
							<!-- 								<div class="form-group" style="display: none;" id="paymentTr"> -->
							<!-- 									<div class="input-group mb-3"> -->
							<%-- 										<label for="pay">信用卡號:</label> <input type="text" name="creditCardNumber" value="${purchaseOrderVO.creditCardNumber}" --%>
							<!-- 											class="form-control" aria-label="Default" -->
							<!-- 											aria-describedby="inputGroup-sizing-default"> -->
							<!-- 									</div> -->
							<!-- 									<div class="input-group mb-3"> -->
							<%-- 										<label for="pay">末三碼:</label> <input type="text" name="lastThreeNumber" value="${purchaseOrderVO.lastThreeNumber}" --%>
							<!-- 											class="form-control" aria-label="Default" -->
							<!-- 											aria-describedby="inputGroup-sizing-default"> -->
							<!-- 									</div> -->
							<!-- 								</div> -->
						...
						<!-- 填寫地址-start -->
								...
								<div class="btn-wrapper" style="text-align: right; padding-top: 5px;">
									<a href="#" style="font-family: Microsoft JhengHei" class="btn btn-element btn-medium-size btn-main-color btn-rounded" id="magicalButton" style="margin-top: 0;">MagicalButton</a>
									<a href="#" style="font-family: Microsoft JhengHei" class="btn btn-element btn-medium-size btn-main-color btn-rounded" id="productSubmit" style="margin-top: 0;" onclick=sendEmail();>確認資料無誤，送出訂單</a>
								</div>
								...
								<!--買家會員編號 -->
								<input type="hidden" id="memIdSeller" name="memIdSeller" value="${productVO.memId}">
								<!--買家會員編號 -->
						</div>
						<!---------------------------------填寫購物資料------------------------------------>
					</div>
