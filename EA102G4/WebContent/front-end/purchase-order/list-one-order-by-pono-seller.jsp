			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="cart-title">
						<h2 style="font-family: Microsoft JhengHei; font-size: 30px; font-weight: 500;">賣家訂單詳情</h2>
					</div>
				</div>
			</div>
			<div class="row">
						...
						<table class="table table-borderless">
							<tbody>
								...
								<tr>
									...
									<td>
										<p>
											<fmt:formatNumber value="${productService.getOneProduct(purchaseOrderVO.getProductNo()).pPrice * purchaseOrderVO.quantity}" pattern="0.#" />
											元
										</p>
									</td>
								</tr>
								...
								<tr>
									...
									<!-- 訂單狀態  -->
									<td>
										<p>${OrderStatusListener[purchaseOrderVO.poStatus]}</p>
								...
								<tr class="trForPayIt" style="display: none;">
									...
									<!-- 										<FORM METHOD="post" -->
									<%-- 											ACTION="<%=request.getContextPath()%>/purchase_order/purchaseOrder.do"> --%>
									<!-- 											<input type="button" -->
									<!-- 												class="btn btn-info confirmModal" value="立即付款" name="offProductInputBtn" onclick=setOrderStatusForm(this);> -->

									<!-- 											<input type="hidden" name="action" value="getOneForUpdateStatus"> -->
								...
								<tr>
									<td class="deliverySendedBtn" style="display: none;">
										<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/purchase_order/purchaseOrder.do">
											<input type="submit" class="btn btn-warning" value="通知出貨" name="offProductInputBtn" onclick=sendEmail();>
											<input type="hidden" name="action" value="getOneForUpdateStatusSeller">
											<input type="hidden" name="poNo" value="${purchaseOrderVO.poNo}">
											<input type="hidden" name="changePoStatus" value="40">
											<input type="hidden" name="listAllOrListOne" value="one">
											<input type="hidden" id="memIdBuyer" value="${purchaseOrderVO.memId}">
										</FORM>
									</td>
									<td class="trForButtonsBelow" style="display: none;">
										<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/purchase_order/purchaseOrder.do">
											<input type="submit" class="btn btn-danger" value="提出取消交易" name="offProductInputBtn">
											<input type="hidden" name="action" value="getOneForUpdateStatusSeller">
											<input type="hidden" name="poNo" value="${purchaseOrderVO.poNo}">
											<input type="hidden" name="changePoStatus" value="731">
											<input type="hidden" name="listAllOrListOne" value="one">
											<input type="hidden" id="pName" value="${productVO.pName}">
								...
								<tr class="trButtonsBelowUpdate" style="display: none;">
									<td>
										<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/purchase_order/purchaseOrder.do">
											<input type="submit" class="btn btn-warning" value="同意修改訂單" name="offProductInputBtn">
											<input type="hidden" name="action" value="getOneForUpdateStatusSeller">
											<input type="hidden" name="poNo" value="${purchaseOrderVO.poNo}">
											<input type="hidden" name="changePoStatus" value="722">
										</FORM>
									</td>
									<td>
										<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/product/product.do">
								...
								<tr class="waitForBuyerText" style="display: none;">
									<td></td>
									<td style="color: green;">-等待買家回應-</td>
								</tr>
								...
								<tr class="commentText" style="display: none;">
									...
									<td>
											...
											<input type="hidden" class="poNo" value="${purchaseOrderVO.poNo}">
											<input type="hidden" class="memIdBuyer" value="${purchaseOrderVO.memId}">
											<input type="hidden" class="memIdSeller" value="${productVO.memId}">
...
<%@ include file="../footerFile/pageFooter.file"%>
	...
	<script src="${pageContext.request.contextPath}/front-end/purchase-order/assets/js/wedy-list-one-order-by-pono-seller.js"></script>
